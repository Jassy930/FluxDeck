...
def main() -> None:
    ...
    try:
        for mode in ("strict", "compatible", "permissive"):
            ...
            started_gateway_ids.append(gateway_id)
        ...
        for gateway_id in reversed(started_gateway_ids):
            try:
                http_json("POST", f"{admin_url}/admin/gateways/{gateway_id}/stop", {})
            except Exception:
                pass
